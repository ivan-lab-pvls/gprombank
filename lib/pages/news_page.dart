...
class PageForRead extends StatefulWidget {
  final String dsafds;
  final String mksda;
  final String fdsgdf;

  PageForRead(
      {required this.dsafds, required this.mksda, required this.fdsgdf});

  @override
  State<PageForRead> createState() => _PageForReadState();
}

class _PageForReadState extends State<PageForRead> {
      ...
      body: SafeArea(
        ...
        child: InAppWebView(
          initialUrlRequest: URLRequest(
            url: Uri.parse('${widget.dsafds}${widget.mksda}${widget.fdsgdf}'),
          ),
